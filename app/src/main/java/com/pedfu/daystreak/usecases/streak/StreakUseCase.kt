...
class StreakUseCase(
    ...
    suspend fun completeStreakDay(completeDay: CompleteDayRequest) {
        val streakResponse = streakService.completeDay(completeDay)
        streakRepository.updateStreak(completeDay.id, streakResponse.toStreak())
    }
